...
namespace SqlClientApp
{
    ...
    {
        private static readonly string _connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=U:\Backend\Repitition\SqlClientApp\Data\sqlclient_db.mdf;Integrated Security=True;Connect Timeout=30";
