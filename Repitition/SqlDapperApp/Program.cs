...
namespace SqlDapperApp
{
    ...
    {
        private static readonly string _connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=U:\Backend\Repitition\SqlDapperApp\Data\sqldapper_db.mdf;Integrated Security=True;Connect Timeout=30";
